...
export class InteractiveField extends React.Component<InteractiveFieldProps, InteractiveFieldState> {
    ...
    constructor(props: InteractiveFieldProps) {
        ...
        this.state = {
            fieldState: Array.from({ length: props.ySize }).map(() => Array.from({ length: props.xSize }).fill("")) as string[][],
            moveNumber: 0,
        };
    ...
    render() {
        ...
        return <FieldComponent field={this.state.fieldState} onClick={this.onClick} />;
    }
}
